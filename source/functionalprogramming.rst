...
If we wanted to compute a *sequence of result values*, one for each item, we could use ``scanLeft`` (examples are available `here <https://github.com/lucproglangcourse/iterators-scala>`_).
